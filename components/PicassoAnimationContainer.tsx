...
import OrbitalCircle from "./OrbitalCircle";
...
const PicassoAnimationContainer: React.FunctionComponent = ({}) => (
    <div className={styles.ctn}>
        ...
        <OrbitalCircle idx={0} radius={290} x={100} y={100} translateX={-300} translateY={-50} type={"circle"} color={"#a02921"} figureSize={80}/>
        <Orbit idx={0} radius={300} width={2} translateX={100} translateY={140} color={'#05244D'}/>
        <OrbitalCircle idx={1} radius={340} x={100} y={100} translateX={60} translateY={400} translateZ={100} type={"circle"} color={"#a02921"} figureSize={80}/>
        ...
        <OrbitalCircle idx={1} radius={190} x={100} y={100} translateX={650} translateY={550} type={"triangle"} color={"#a02921"} figureSize={80}/>
    </div>
)
